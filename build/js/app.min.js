    ...
    dashboard: {
      ...
      dropdownButtons: function dropdownButtons() {
        ...
        self.$dom.dropdownBtns.forEach(function (el) {
          ...
          document.addEventListener('click', function (e) {
            ...
            if (!el.classList.contains('is-active')) return; // Clicking inside dropdown

            var dropdown = el.querySelector('.dropdown');
            if (e.target === dropdown || dropdown.contains(e.target)) return; // Clicking target

            if (e.target === el.target || el.contains(e.target)) return; // Close the dropdown
      ...
      tables: function tables() {
        ...
        self.$dom.tables.dots.forEach(function (el) {
          el.addEventListener('click', function (e) {
            e.preventDefault(); // Check if current active dots
...
},{"./flatpickr.js":2,"./select.js":3}],2:[function(require,module,exports){
"use strict";
...
},{"./tether.js":4}],4:[function(require,module,exports){
"use strict";
